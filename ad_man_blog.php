...
<body>
	<div id="header">
		...
		<div id="navigation">
			<ul>
				...
				<li class="selected"><a href="ad_man_blog.php">Blog</a></li>
    ...
    <div class="background">
        <div id="">
				<h1>Blog  </h1>
				<a href="ad_add_blog.php" class="icon">Thêm mới</a>
				<table>
					<tr>
						<td>TÁC GIẢ</td>
						<td>Tên</td>
					...
					<?php
					$select_blog=$get_data->select_blog();
                    foreach($select_blog as $se_blog){
                    ?>
					<tr>
                        <td><?php echo $se_blog['Fullname']?></td>
						...
						<td><img src="img_blog/<?php echo $se_blog['image']?>" class="img"></td>
						<td><a href="ad_blog_update.php?update_blog=<?php echo $se_blog['id_blog']?>" class="icon"><i class='bx bxs-edit-alt' ></i></a>
                        <td><a href="ad_blog_delete.php?delete=<?php echo $se_blog['id_blog']?>" onclick="return (confirm('Are you sure dalete?'))" class="icon"><i class='bx bxs-trash'></i></a></td>

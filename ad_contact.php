	...
	<div id="header">
		...
		<div id="navigation">
			<ul>
				...
				<li class="selected"><a href="ad_contact.php">Contact</a></li>
    ...
    <div class="background">
        <div id="">
				...
				<table>
                    ...
                    ?>
					<tr>
						<td><?php echo $se_contact['id_ct']?></td>
                        <td><?php echo $se_contact['name']?></td>
						<td><?php echo $se_contact['email']?></td>
						<!-- <td><a href="ad_contact_update.php?update_blog=<?php //echo $se_contact['id_blog']?>" class="icon"><i class='bx bxs-edit-alt' ></i></a>
                        <td><a href="ad_contact_delete.php?delete=<?php //echo $se_contact['id_blog']?>" onclick="return (confirm('Are you sure dalete?'))" class="icon"><i class='bx bxs-trash'></i></a></td> -->
					<?php

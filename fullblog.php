	...
	<div id="contents">
		<div class="background">
			<div id="blogs">
				...
				<div class="section">
				<?php
                    $id_blog=$_GET['content'];//nhận giá trị truyền từ trang blog.php
					$select_blog=$get_data->select_blog_id($id_blog);
					foreach($select_blog as $se){					
					?>
					<li>
						<span class="time"><?php echo $se['Date_blog'];?>|<?php echo $se['Fullname']?></span>
						<h4><?php echo $se['Name_blog'];?></h4>
						<img src="img_blog/<?php echo $se['image'];?>" alt="" class="imgblog">
						<p>
							<?php echo $se['S_blog']; ?>
						</p>
                        <p>

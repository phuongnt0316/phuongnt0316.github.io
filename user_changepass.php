		...
		<div class="background">
			...
			<div class="container" id="cont">
				<h1>Change password</h1>
							...
							<input type="password" name="txtOldPassWord" class="inputs" placeholder="Password"  >
							<label>Nhập mật khẩu mới</label>
							<input type="password" name="txtPassWord" class="inputs" placeholder="Password"  >
							<label>Nhập lại mật khẩu mới</label>
							<input type="password" name="txtRePass" class="inputs" placeholder="Repassword"  >
							<a href="forgotpass.php"> Bạn quên mật khẩu?</a></li>						
							</div>
							<input type="submit" name="sbm" value="Lưu thay đổi" class="btn1"><br>   
            </div>	
			</form>
<?php
if(isset($_POST["sbm"])){
	if($_SESSION['pass']!=$_POST["txtOldPassWord"])
	{
    ...
    {
$changepass=$get_data->update_pass($id_regt,$_POST["txtPassWord"]);
if ($changepass)
{

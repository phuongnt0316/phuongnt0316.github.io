...
<body>
    ...
    <label><b>Tên</b></label>
    <input type="text"  name="txtname" placeholder="NAME" class="name">
    <input type="submit" name="sbm_insert" value="Thêm" class="btn1">
    </div>
    </form>
    </div>
    ...
    if(isset($_POST['sbm_insert'])){
        $update=$get_data->insert_id($_POST['txtname']);
        if($update){
